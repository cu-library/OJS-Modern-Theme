...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td >{fieldLabel name="authors-$authorIndex-email" required="true" key="user.email"}</td>
	...
	<tr valign="top">
		<td >{fieldLabel name="authors-$authorIndex-affiliation" key="user.affiliation"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="authors-$authorIndex-country" key="common.country"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="authors-$authorIndex-biography" key="user.biography"}<br />{translate key="user.biography.description"}</td>
...
{call_hook name="Templates::Submission::MetadataEdit::Authors"}
	...
	{if $smarty.foreach.authors.total > 1}
	<tr valign="top">
		<td >{translate key="author.submit.reorder"}</td>
	...
	<tr valign="top">
		<td>&nbsp;</td>
		<td ><input type="radio" name="primaryContact" id="primaryContact-{$authorIndex|escape}" value="{$authorIndex|escape}"{if $primaryContact == $authorIndex} checked="checked"{/if} /> <label for="primaryContact-{$authorIndex|escape}">{translate key="author.submit.selectPrincipalContact"}</label></td>
	...
	<tr valign="top">
		<td >{fieldLabel name="authors-0-affiliation" key="user.affiliation"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="authors-0-email" required="true" key="user.email"}</td>
		<td class="value"><input type="text" name="authors[0][email]" id="authors-0-email" size="30" maxlength="90" class="textField" /></td>
	</tr>
	<tr valign="top">
		<td >{fieldLabel name="authors-0-url" key="user.url"}</td>
	...
	{/if}
	<tr valign="top">
		<td >{fieldLabel name="authors-0-biography" key="user.biography"}<br />{translate key="user.biography.description"}</td>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td >{if $section->getAbstractsNotRequired()==0}{fieldLabel name="abstract" required="true" key="article.abstract"}{else}{fieldLabel name="abstract" key="article.abstract"}{/if}</td>
...
<table width="100%" class="data">
	<tr valign="top">
		<td  colspan="2"><input type="checkbox" name="showCoverPage[{$formLocale|escape}]" id="showCoverPage" value="1" {if $showCoverPage[$formLocale]} checked="checked"{/if} /> <label for="showCoverPage">{translate key="editor.article.showCoverPage"}</label></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		<td width="20%" >{fieldLabel name="hideCoverPageToc" key="editor.article.coverPageDisplay"}</td>
...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td >{fieldLabel name="discipline" key="article.discipline"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="subjectClass" key="article.subjectClassification"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="subject" key="article.subject"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="coverageGeo" key="article.coverageGeo"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="coverageChron" key="article.coverageChron"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="coverageSample" key="article.coverageSample"}</td>
		<td class="value">
	...
	<tr valign="top">
		<td >{fieldLabel name="type" key="article.type"}</td>
		<td class="value">
	...
	{/if}
	<tr valign="top">
		<td width="20%" >{fieldLabel name="language" key="article.language"}</td>
		<td width="80%" class="value">
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" >{fieldLabel name="hideAuthor" key="issue.toc"}</td>
