...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td ><label for="sharingUserName">{translate key="rt.admin.sharing.userNameLabel"}</label></td>
		<td><input type="text" name="sharingUserName" id="sharingUserName" value="{$sharingUserName|escape}"/></td>
	</tr>
	<tr valign="top">
		<td ><label for="sharingButtonStyle">{translate key="rt.admin.sharing.buttonStyleLabel"}</label></td>
		<td>
...
<table width="100%" class="data">
	<tr valign="top">
		<td  width="20%"><label for="sharingBrand">{translate key="rt.admin.sharing.brandLabel"}</label></td>
		<td width="80%"><input type="text" name="sharingBrand" id="sharingBrand" value="{$sharingBrand|escape}"/></td>
	</tr>
	<tr valign="top">
		<td ><label for="sharingDropDown">{translate key="rt.admin.sharing.dropDownLabel"}</label></td>
		<td><textarea rows="4" cols="20" name="sharingDropDown" id="sharingDropDown">{$sharingDropDown|escape}</textarea></td>
	</tr>
	<tr valign="top">
		<td ><label for="sharingLanguage">{translate key="rt.admin.sharing.languageLabel"}</label></td>
		<td>
			{html_options name="sharingLanguage" id="sharingLanguage" options="$sharingLanguageOptions" selected=$sharingLanguage}
		</td>
	</tr>
	<tr valign="top">
		<td ><label for="sharingLogo">{translate key="rt.admin.sharing.logolabel"}</label></td>
		<td><input type="text" name="sharingLogo" id="sharingLogo" value="{$sharingLogo}" /></td>
	</tr>
	<tr valign="top">
		<td ><label for="sharingLogoBackground">{translate key="rt.admin.sharing.logoBackgroundLabel"}</label></td>
		<td><input type="text" name="sharingLogoBackground" id="sharingLogoBackground" value="{$sharingLogoBackground|escape}"/></td>
	</tr>
	<tr valign="top">
		<td ><label for="sharingLogoColor">{translate key="rt.admin.sharing.logoColorLabel"}</label></td>
